...
<%
	...
	List<BbsDTO> list = dao.buylist(map);
	//전체 레코드 개수(col, word)
	int totalRecord = dao.buytotal(map);
%>
...
<body>
	...
	<div class="w3-main" style="margin-left: 340px; margin-right: 40px">
		...
		<div class="w3-container" style="margin-top: 80px" id="showcase">
			<h1 class="w3-xxlarge">
				<span class="glyphicon glyphicon-shopping-cart"></span><b> 구매 </b>
			</h1>
			
<hr>
<div align='center'>
			<form method="post" action="./buyList.jsp">
				<select name="col">
					<option value="id"
						<%if (col.equals("id")) {
				out.print("selected");
