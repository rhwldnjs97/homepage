...
<%
	...
	List<BbsDTO> list = dao.selllist(map);
	//전체 레코드 개수(col, word)
	int totalRecord = dao.selltotal(map);
%>
...
<body>
	...
	<div class="w3-main" style="margin-left: 340px; margin-right: 40px">
		...
		<div class="w3-container" style="margin-top: 80px" id="showcase">
			<h1 class="w3-xxlarge">
				<span class="glyphicon glyphicon-inbox"></span><b> 판매 </b>
			</h1>
			
<hr>
<div align='center'>
			<form method="post" action="./sellList.jsp">
				<select name="col">
					<option value="id"
						<%if (col.equals("id")) {
				out.print("selected");
