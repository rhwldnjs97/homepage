...
<body>
	...
	<div class="w3-main" style="margin-left: 340px; margin-right: 40px">
		...
		<div class="w3-container" style="margin-top: 80px" id="showcase">
			<h1 class="w3-xxlarge">
				<span class="glyphicon glyphicon-list-alt"></span><b> 글 목록 </b>
			</h1>
			...
			<div align='center'>
				...
				out.print("selected");
					...
					%>
					<button type="button"
						onclick="location.href='../bbs/createForm.jsp'"
						class="w3-button w3-padding-small w3-black w3-right">
						글 작성 <span class="glyphicon glyphicon-pencil"></span>
					</button>
					<%
						}
					%>
			...
			<TABLE style="width: 1000px;" class="w3-table-all">
				...
				<%
						...
						for (int i = 0; i < list.size(); i++) {
							...
							if (!dto.getDiv().equals("A03")) {
				%>
				<tr>
					<td style="text-align: center;"><%=dto.getBbsno()%></td>
					<td style="text-align: center;">
						<%
							if (dto.getDiv().equals("A01")) {
						%> 판매 <%
							} else if (dto.getDiv().equals("A02")) {
						%>
						구매 <%
							} else if (dto.getDiv().equals("A04")) {
						%> 공지 <%
							}
						%>
					</td>
