...
<body>
	...
	<div class="w3-main" style="margin-left: 340px; margin-right: 40px">
		<div class="w3-container" id="packages" style="margin-top: 75px">
			...
			<h1 class="w3-xxxlarge w3-text-black">회원가입</h1>
			<hr style="width: 185px; border: 5px solid black" class="w3-round">

			<div class="w3-row-padding">
				<div class="w3-half w3-margin-bottom">

						<FORM name='frm' method='POST' action='./pcreateProc.jsp' enctype="multipart/form-data" onsubmit="return inputCheck(this)"
						...
						<div class="w3-row w3-section">
							...
							<div class="w3-rest">
								<input class="w3-input w3-border" type="file" name="fname" accept=".jpg,.png,.gif">
							</div>
						</div>
						...
						<div class="w3-row w3-section">
							...
							<div class="w3-rest">
								<input type="text" class="w3-input w3-border" name="id" size="15">
						...
						<div class="w3-row w3-section">
							...
							<div class="w3-rest">
								<input class="w3-input w3-border" type="text" name="email" size="15"> <input
						...
						<div class="w3-row w3-section">
							...
							<div class="w3-rest">
								...
								name="zipcode" size="7" id="sample6_postcode" placeholder="우편번호">
						...
						<div class="w3-row w3-section">
							...
							<div class="w3-rest">
								<input type="text" class="w3-input w3-border"
								name="address1" size="40" id="sample6_address" placeholder="주소">
						...
						<p class="w3-center">
							<input type='submit' value='가입' class="w3-button w3-section w3-black w3-ripple">
							<input type='button' value='취소' onclick="location.href='./loginForm.jsp'" class="w3-button w3-section w3-black w3-ripple">
						</p>
					</form>
				</div>
			</div>
