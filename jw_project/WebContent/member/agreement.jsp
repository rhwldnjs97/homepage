 ...
 -->
	<div class="w3-main" style="margin-left: 340px; margin-right: 40px">
		...
		<form name="frm" method="post" action="./createForm.jsp"
			onsubmit="return send();" class="w3-container w3-card-4 w3-light-grey w3-text-black w3-margin">
...
본 약관은 2005. 7. 18. 부터 적용하고, 2004. 10. 11.부터 적용되던 종전의 약관은 본 약관으로 대체합니다.  
			...
			<label><input type="checkbox" name="agree" value="1">
				약관에 동의합니다</input></label>
				</p>
			<p class="w3-center">
				<input type="submit" value="회원가입"
					class="w3-button w3-padding-large w3-black w3-margin-bottom"></input>
